...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_classnames_index_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../node_modules/classnames/index.js */ "./node_modules/@coreui/react/dist/esm/node_modules/classnames/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _conditional_portal_CConditionalPortal_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../conditional-portal/CConditionalPortal.js */ "./node_modules/@coreui/react/dist/esm/components/conditional-portal/CConditionalPortal.js");
...
/* harmony import */ var _props_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../props.js */ "./node_modules/@coreui/react/dist/esm/props.js");
/* harmony import */ var _utils_getTransitionDurationFromElement_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../utils/getTransitionDurationFromElement.js */ "./node_modules/@coreui/react/dist/esm/utils/getTransitionDurationFromElement.js");
/* harmony import */ var _utils_getRTLPlacement_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/getRTLPlacement.js */ "./node_modules/@coreui/react/dist/esm/utils/getRTLPlacement.js");
/* harmony import */ var _node_modules_react_transition_group_esm_Transition_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../node_modules/react-transition-group/esm/Transition.js */ "./node_modules/@coreui/react/dist/esm/node_modules/react-transition-group/esm/Transition.js");
...
var CPopover = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function (_a, ref) {
    var children = _a.children, _b = _a.animation, animation = _b === void 0 ? true : _b, className = _a.className, container = _a.container, content = _a.content, _c = _a.delay, delay = _c === void 0 ? 0 : _c, _d = _a.fallbackPlacements, fallbackPlacements = _d === void 0 ? ['top', 'right', 'bottom', 'left'] : _d, _e = _a.offset, offset = _e === void 0 ? [0, 8] : _e, onHide = _a.onHide; _a.onShow; var _f = _a.placement, placement = _f === void 0 ? 'top' : _f, title = _a.title, _g = _a.trigger, trigger = _g === void 0 ? 'click' : _g, visible = _a.visible, rest = (0,_node_modules_tslib_tslib_es6_js__WEBPACK_IMPORTED_MODULE_1__.__rest)(_a, ["children", "animation", "className", "container", "content", "delay", "fallbackPlacements", "offset", "onHide", "onShow", "placement", "title", "trigger", "visible"]);
    var popoverRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
    var togglerRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
    var forkedRef = (0,_hooks_useForkedRef_js__WEBPACK_IMPORTED_MODULE_2__.useForkedRef)(ref, popoverRef);
    var uID = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)("popover".concat(Math.floor(Math.random() * 1000000)));
    var _h = (0,_hooks_usePopper_js__WEBPACK_IMPORTED_MODULE_3__.usePopper)(), initPopper = _h.initPopper, destroyPopper = _h.destroyPopper;
    var _j = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(visible), _visible = _j[0], setVisible = _j[1];
    ...
    var popperConfig = {
        ...
        placement: (0,_utils_getRTLPlacement_js__WEBPACK_IMPORTED_MODULE_4__["default"])(placement, togglerRef.current),
    };
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_conditional_portal_CConditionalPortal_js__WEBPACK_IMPORTED_MODULE_5__.CConditionalPortal, { container: container, portal: true },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_node_modules_react_transition_group_esm_Transition_js__WEBPACK_IMPORTED_MODULE_6__["default"], { in: _visible, mountOnEnter: true, nodeRef: popoverRef, onEnter: function () {
                    ...
                    exit: popoverRef.current
                        ? (0,_utils_getTransitionDurationFromElement_js__WEBPACK_IMPORTED_MODULE_7__["default"])(popoverRef.current) + 50
                        : 200,
                }, unmountOnExit: true }, function (state) { return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", (0,_node_modules_tslib_tslib_es6_js__WEBPACK_IMPORTED_MODULE_1__.__assign)({ className: (0,_node_modules_classnames_index_js__WEBPACK_IMPORTED_MODULE_8__["default"])('popover', 'bs-popover-auto', {
                    fade: animation,
                    show: state === 'entered',
                }, className), id: uID.current, ref: forkedRef, role: "tooltip", style: {
                    display: 'none',
                } }, rest),
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "popover-arrow" }),
...
CPopover.propTypes = {
    animation: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().bool),
    children: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().node),
    className: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().string),
    container: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().any),
    content: prop_types__WEBPACK_IMPORTED_MODULE_9___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_9___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_9___default().node)]),
    delay: prop_types__WEBPACK_IMPORTED_MODULE_9___default().oneOfType([
        (prop_types__WEBPACK_IMPORTED_MODULE_9___default().number),
        prop_types__WEBPACK_IMPORTED_MODULE_9___default().shape({
            show: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().number).isRequired,
            hide: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().number).isRequired,
        }),
    ]),
    fallbackPlacements: _props_js__WEBPACK_IMPORTED_MODULE_10__.fallbackPlacementsPropType,
    offset: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().any), // TODO: find good proptype
    onHide: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().func),
    onShow: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().func),
    placement: prop_types__WEBPACK_IMPORTED_MODULE_9___default().oneOf(['auto', 'top', 'right', 'bottom', 'left']),
    title: prop_types__WEBPACK_IMPORTED_MODULE_9___default().oneOfType([(prop_types__WEBPACK_IMPORTED_MODULE_9___default().string), (prop_types__WEBPACK_IMPORTED_MODULE_9___default().node)]),
    trigger: _props_js__WEBPACK_IMPORTED_MODULE_10__.triggerPropType,
    visible: (prop_types__WEBPACK_IMPORTED_MODULE_9___default().bool),
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ getRTLPlacement)
/* harmony export */ });
/* harmony import */ var _isRTL_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./isRTL.js */ "./node_modules/@coreui/react/dist/esm/utils/isRTL.js");


var getRTLPlacement = function (placement, element) {
    switch (placement) {
        case 'right': {
            return (0,_isRTL_js__WEBPACK_IMPORTED_MODULE_0__["default"])(element) ? 'left' : 'right';
        }
        case 'left': {
            return (0,_isRTL_js__WEBPACK_IMPORTED_MODULE_0__["default"])(element) ? 'right' : 'left';
        }
        default: {
            return placement;
        }
...
/* harmony import */ var _coreui_react__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @coreui/react */ "./node_modules/@coreui/react/dist/esm/components/popover/CPopover.js");
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_4__.CCol, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_5__.CCard, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_6__.CCardHeader, {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_components__WEBPACK_IMPORTED_MODULE_1__.DocsExample, {
            href: "components/popover",
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_8__.CPopover, {
              title: "Popover title",
              content: "And here\u2019s some amazing content. It\u2019s very engaging. Right?",
              placement: "right",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_9__.CButton, {
                color: "danger",
                size: "lg",
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_5__.CCard, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(_coreui_react__WEBPACK_IMPORTED_MODULE_6__.CCardHeader, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("p", {
            ...
            }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_8__.CPopover, {
              content: "Vivamus sagittis lacus vel augue laoreet rutrum faucibus.",
              placement: "right",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_coreui_react__WEBPACK_IMPORTED_MODULE_9__.CButton, {
                color: "secondary",
